                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="name" data-editable="true">Judul Berita</th>
                                            <th data-field="name" data-editable="true">Isi Berita</th>
                                            <th data-field="name" data-editable="true">Jumlah Pembaca</th>
                                            <th >Aksi</th>
        ...
        <form action="<?php echo base_url(). 'postingan/add'; ?>" method="post" class="form-horizontal" role="form">
            <div class="modal-body">                                   
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="namaKategori" name="namaKategoris" required>
                        </div>
                    </div>     
