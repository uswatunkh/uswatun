                    ...
                    <div class="header-right-info">
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            <li class="nav-item dropdown">
                                <a href="<?php echo base_url(); ?>horizontal/#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span class="adminpro-icon adminpro-chat-pro"></span><span class="indicator-ms"></span></a>
                                <div role="menu" class="author-message-top dropdown-menu animated flipInX">
                                    ...
                                    <ul class="message-menu">
                                        <li>
                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url(); ?>horizontal/img/message/1.jpg" alt="">
                                                </div>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url(); ?>horizontal/img/message/4.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Sulaiman din</h2>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url(); ?>horizontal/img/message/3.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Victor Jara</h2>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url(); ?>horizontal/img/message/2.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Victor Jara</h2>
                                    ...
                                    <div class="message-view">
                                        <a href="<?php echo base_url(); ?>horizontal/#">View All Messages</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item nav-setting-open"><a href="<?php echo base_url(); ?>horizontal/#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-tasks"></i></a>

                                <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated flipInX">
                                    <ul class="nav nav-tabs custon-set-tab">
                                        <li class="active"><a data-toggle="tab" href="<?php echo base_url(); ?>horizontal/#Notes">Notes</a>
                                        </li>
                                        <li><a data-toggle="tab" href="<?php echo base_url(); ?>horizontal/#Projects">Projects</a>
                                        </li>
                                        <li><a data-toggle="tab" href="<?php echo base_url(); ?>horizontal/#Settings">Settings</a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <ul class="notes-menu-list">
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/5.jpg" alt="" />
                                                                    </div>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/1.jpg" alt="" />
                                                                    </div>
                                                                    <div class="notes-content">
                                                                        <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                        <span>Yesterday 2:45 pm</span>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/2.jpg" alt="" />
                                                                    </div>
                                                                    <div class="notes-content">
                                                                        <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                        <span>Yesterday 2:45 pm</span>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/3.jpg" alt="" />
                                                                    </div>
                                                                    <div class="notes-content">
                                                                        <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                        <span>Yesterday 2:45 pm</span>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/4.jpg" alt="" />
                                                                    </div>
                                                                    <div class="notes-content">
                                                                        <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                        <span>Yesterday 2:45 pm</span>
                                                        ...
                                                        <li>
                                                            <a href="<?php echo base_url(); ?>horizontal/#">
                                                                <div class="notes-list-flow">
                                                                    <div class="notes-img">
                                                                        <img src="<?php echo base_url(); ?>horizontal/img/notification/6.jpg" alt="" />
                                                                    </div>
                                                                    <div class="notes-content">
                                                                        <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                        <span>Yesterday 2:45 pm</span>
